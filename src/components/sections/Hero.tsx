...
export function Hero() {
  return (
    <AuroraBackground id="home">
      <div className="relative z-10 min-h-screen flex items-center justify-center safe-container py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto w-full">
          {/* Split Screen Layout */}
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 items-center min-h-[80vh] lg:min-h-[70vh]">
            ...
            >
              <motion.h1
                ...
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-black dark:text-white mb-4 lg:mb-6 leading-tight text-responsive"
              >
                Hi, I'm{" "}
            ...
            <motion.div
              ...
              className="relative flex justify-center lg:justify-end order-1 lg:order-2 px-4 lg:px-0"
            >
              ...
              <div className="absolute inset-0 overflow-hidden">
                ...
                <motion.div
                  ...
                  className="hidden sm:block absolute top-6 lg:top-10 left-6 lg:left-10 w-12 h-12 lg:w-20 lg:h-20 bg-blue-500/20 rounded-full blur-xl"
                />
                <motion.div
                  initial={{ opacity: 0, scale: 0 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 1, delay: 2 }}
                  className="hidden sm:block absolute bottom-12 lg:bottom-20 right-6 lg:right-10 w-10 h-10 lg:w-16 lg:h-16 bg-purple-500/20 rounded-full blur-lg"
                />
                <motion.div
                  initial={{ opacity: 0, scale: 0 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 1, delay: 1.8 }}
                  className="hidden sm:block absolute top-1/2 left-0 w-8 h-8 lg:w-12 lg:h-12 bg-pink-500/20 rounded-full blur-lg"
                />
              </div>
